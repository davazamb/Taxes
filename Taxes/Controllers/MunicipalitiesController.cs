...
namespace Taxes.Controllers
{
    public class MunicipalitiesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MunicipalityId,Name,DepartmentId")] Municipality municipality)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MunicipalityId,Name,DepartmentId")] Municipality municipality)
        {
            if (ModelState.IsValid)
            {
